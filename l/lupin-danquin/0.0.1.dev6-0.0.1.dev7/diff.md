# Comparing `tmp/lupin-danquin-0.0.1.dev6.tar.gz` & `tmp/lupin-danquin-0.0.1.dev7.tar.gz`
...
## Comparing `lupin-danquin-0.0.1.dev6.tar` & `lupin-danquin-0.0.1.dev7.tar`
...
### Comparing `lupin-danquin-0.0.1.dev6/LICENCE` & `lupin-danquin-0.0.1.dev7/LICENCE`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/PKG-INFO` & `lupin-danquin-0.0.1.dev7/PKG-INFO`
...
### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/assets/BeginingOfFile.md` & `lupin-danquin-0.0.1.dev7/lupin_danquin/assets/BeginingOfFile.md`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/check_coding_rules.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/check_coding_rules.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/core/application.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/core/application.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/core/global_variable.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/core/global_variable.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/core/local_variable.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/core/local_variable.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/core/parameter.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/core/parameter.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/core/program.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/core/program.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/core/tools/utils.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/core/tools/utils.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/core/val3_doc_generator/val3_doc_generator.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/core/val3_doc_generator/val3_doc_generator.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/run.py` & `lupin-danquin-0.0.1.dev7/lupin_danquin/run.py`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin/templates/val3_documentation_md.j2` & `lupin-danquin-0.0.1.dev7/lupin_danquin/templates/val3_documentation_md.j2`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin.egg-info/PKG-INFO` & `lupin-danquin-0.0.1.dev7/lupin_danquin.egg-info/PKG-INFO`
...
### Comparing `lupin-danquin-0.0.1.dev6/lupin_danquin.egg-info/SOURCES.txt` & `lupin-danquin-0.0.1.dev7/lupin_danquin.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `lupin-danquin-0.0.1.dev6/setup.cfg` & `lupin-danquin-0.0.1.dev7/setup.cfg`
