# Comparing `tmp/jal-2023.4.3.tar.gz` & `tmp/jal-2023.4.4.tar.gz`
...
### Comparing `jal-2023.4.3/jal/data_export/templates/tax_prt_dividends.json` & `jal-2023.4.4/jal/data_export/templates/tax_prt_dividends.json`
...
### Comparing `jal-2023.4.3/jal/data_import/statement.py` & `jal-2023.4.4/jal/data_import/statement.py`
...
### Comparing `jal-2023.4.3/jal/data_import/statements.py` & `jal-2023.4.4/jal/data_import/statements.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/account.py` & `jal-2023.4.4/jal/db/account.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/asset.py` & `jal-2023.4.4/jal/db/asset.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/backup_restore.py` & `jal-2023.4.4/jal/db/backup_restore.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/balances_model.py` & `jal-2023.4.4/jal/db/balances_model.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/category.py` & `jal-2023.4.4/jal/db/category.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/closed_trade.py` & `jal-2023.4.4/jal/db/closed_trade.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/country.py` & `jal-2023.4.4/jal/db/country.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/db.py` & `jal-2023.4.4/jal/db/db.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/helpers.py` & `jal-2023.4.4/jal/db/helpers.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/holdings_model.py` & `jal-2023.4.4/jal/db/holdings_model.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/ledger.py` & `jal-2023.4.4/jal/db/ledger.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/operations.py` & `jal-2023.4.4/jal/db/operations.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/operations_model.py` & `jal-2023.4.4/jal/db/operations_model.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/peer.py` & `jal-2023.4.4/jal/db/peer.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/reference_models.py` & `jal-2023.4.4/jal/db/reference_models.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/settings.py` & `jal-2023.4.4/jal/db/settings.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/tax_estimator.py` & `jal-2023.4.4/jal/db/tax_estimator.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/db/view_model.py` & `jal-2023.4.4/jal/db/view_model.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/accept.png` & `jal-2023.4.4/jal/img/accept.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/add.png` & `jal-2023.4.4/jal/img/add.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/add_child.png` & `jal-2023.4.4/jal/img/add_child.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/cancel.png` & `jal-2023.4.4/jal/img/cancel.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/chart.png` & `jal-2023.4.4/jal/img/chart.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/copy.png` & `jal-2023.4.4/jal/img/copy.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/delete.png` & `jal-2023.4.4/jal/img/delete.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/ibkr.png` & `jal-2023.4.4/jal/img/ibkr.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/j2t.png` & `jal-2023.4.4/jal/img/j2t.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/jal.png` & `jal-2023.4.4/jal/img/jal.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/kit.png` & `jal-2023.4.4/jal/img/kit.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/list.png` & `jal-2023.4.4/jal/img/list.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/new.png` & `jal-2023.4.4/jal/img/new.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/open_portfolio.png` & `jal-2023.4.4/jal/img/open_portfolio.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/openbroker.ico` & `jal-2023.4.4/jal/img/openbroker.ico`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/psb.ico` & `jal-2023.4.4/jal/img/psb.ico`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/quik.ico` & `jal-2023.4.4/jal/img/quik.ico`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/reconcile.png` & `jal-2023.4.4/jal/img/reconcile.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/remove.png` & `jal-2023.4.4/jal/img/remove.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/tax.png` & `jal-2023.4.4/jal/img/tax.png`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/img/uralsib.ico` & `jal-2023.4.4/jal/img/uralsib.ico`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/jal.py` & `jal-2023.4.4/jal/jal.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/jal_init.sql` & `jal-2023.4.4/jal/jal_init.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/languages/en.qm` & `jal-2023.4.4/jal/languages/en.qm`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/languages/ru.qm` & `jal-2023.4.4/jal/languages/ru.qm`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/net/downloader.py` & `jal-2023.4.4/jal/net/downloader.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/net/helpers.py` & `jal-2023.4.4/jal/net/helpers.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/pypi_description.md` & `jal-2023.4.4/jal/pypi_description.md`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/category.py` & `jal-2023.4.4/jal/reports/category.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/deals.py` & `jal-2023.4.4/jal/reports/deals.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/holdings.py` & `jal-2023.4.4/jal/reports/holdings.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/income_spending.py` & `jal-2023.4.4/jal/reports/income_spending.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/peer.py` & `jal-2023.4.4/jal/reports/peer.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/profit_loss.py` & `jal-2023.4.4/jal/reports/profit_loss.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/reports.py` & `jal-2023.4.4/jal/reports/reports.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/reports/tag.py` & `jal-2023.4.4/jal/reports/tag.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_category_report.py` & `jal-2023.4.4/jal/ui/reports/ui_category_report.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_deals_report.py` & `jal-2023.4.4/jal/ui/reports/ui_deals_report.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_holdings_report.py` & `jal-2023.4.4/jal/ui/reports/ui_holdings_report.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_income_spending_report.py` & `jal-2023.4.4/jal/ui/reports/ui_income_spending_report.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_peer_report.py` & `jal-2023.4.4/jal/ui/reports/ui_peer_report.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_profit_loss_report.py` & `jal-2023.4.4/jal/ui/reports/ui_profit_loss_report.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_tag_report.py` & `jal-2023.4.4/jal/ui/reports/ui_tag_report.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/reports/ui_tax_estimation.py` & `jal-2023.4.4/jal/ui/reports/ui_tax_estimation.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_asset_dlg.py` & `jal-2023.4.4/jal/ui/ui_asset_dlg.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_flow_export_widget.py` & `jal-2023.4.4/jal/ui/ui_flow_export_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_login_fns_dlg.py` & `jal-2023.4.4/jal/ui/ui_login_fns_dlg.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_main_window.py` & `jal-2023.4.4/jal/ui/ui_main_window.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_operations_widget.py` & `jal-2023.4.4/jal/ui/ui_operations_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_rebuild_window.py` & `jal-2023.4.4/jal/ui/ui_rebuild_window.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_reference_data_dlg.py` & `jal-2023.4.4/jal/ui/ui_reference_data_dlg.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_select_account_dlg.py` & `jal-2023.4.4/jal/ui/ui_select_account_dlg.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_select_reference_dlg.py` & `jal-2023.4.4/jal/ui/ui_select_reference_dlg.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_slip_import_dlg.py` & `jal-2023.4.4/jal/ui/ui_slip_import_dlg.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_tax_export_widget.py` & `jal-2023.4.4/jal/ui/ui_tax_export_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/ui/ui_update_quotes_window.py` & `jal-2023.4.4/jal/ui/ui_update_quotes_window.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_10.sql` & `jal-2023.4.4/jal/updates/jal_delta_10.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_11.sql` & `jal-2023.4.4/jal/updates/jal_delta_11.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_12.sql` & `jal-2023.4.4/jal/updates/jal_delta_12.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_13.sql` & `jal-2023.4.4/jal/updates/jal_delta_13.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_14.sql` & `jal-2023.4.4/jal/updates/jal_delta_14.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_15.sql` & `jal-2023.4.4/jal/updates/jal_delta_15.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_16.sql` & `jal-2023.4.4/jal/updates/jal_delta_16.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_17.sql` & `jal-2023.4.4/jal/updates/jal_delta_17.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_18.sql` & `jal-2023.4.4/jal/updates/jal_delta_18.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_19.sql` & `jal-2023.4.4/jal/updates/jal_delta_19.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_20.sql` & `jal-2023.4.4/jal/updates/jal_delta_20.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_21.sql` & `jal-2023.4.4/jal/updates/jal_delta_21.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_22.sql` & `jal-2023.4.4/jal/updates/jal_delta_22.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_23.sql` & `jal-2023.4.4/jal/updates/jal_delta_23.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_25.sql` & `jal-2023.4.4/jal/updates/jal_delta_25.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_26.sql` & `jal-2023.4.4/jal/updates/jal_delta_26.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_27.sql` & `jal-2023.4.4/jal/updates/jal_delta_27.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_28.sql` & `jal-2023.4.4/jal/updates/jal_delta_28.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_29.sql` & `jal-2023.4.4/jal/updates/jal_delta_29.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_30.sql` & `jal-2023.4.4/jal/updates/jal_delta_30.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_31.sql` & `jal-2023.4.4/jal/updates/jal_delta_31.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_32.sql` & `jal-2023.4.4/jal/updates/jal_delta_32.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_33.sql` & `jal-2023.4.4/jal/updates/jal_delta_33.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_34.sql` & `jal-2023.4.4/jal/updates/jal_delta_34.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_35.sql` & `jal-2023.4.4/jal/updates/jal_delta_35.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_36.sql` & `jal-2023.4.4/jal/updates/jal_delta_36.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_37.sql` & `jal-2023.4.4/jal/updates/jal_delta_37.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_38.sql` & `jal-2023.4.4/jal/updates/jal_delta_38.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_40.sql` & `jal-2023.4.4/jal/updates/jal_delta_40.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_41.sql` & `jal-2023.4.4/jal/updates/jal_delta_41.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_42.sql` & `jal-2023.4.4/jal/updates/jal_delta_42.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_43.sql` & `jal-2023.4.4/jal/updates/jal_delta_43.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/updates/jal_delta_44.sql` & `jal-2023.4.4/jal/updates/jal_delta_44.sql`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/abstract_operation_details.py` & `jal-2023.4.4/jal/widgets/abstract_operation_details.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/account_select.py` & `jal-2023.4.4/jal/widgets/account_select.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/asset_dialog.py` & `jal-2023.4.4/jal/widgets/asset_dialog.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/corporate_action_widget.py` & `jal-2023.4.4/jal/widgets/corporate_action_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/custom/date_range_selector.py` & `jal-2023.4.4/jal/widgets/custom/date_range_selector.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/custom/db_lookup_combobox.py` & `jal-2023.4.4/jal/widgets/custom/db_lookup_combobox.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/custom/log_viewer.py` & `jal-2023.4.4/jal/widgets/custom/log_viewer.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/delegates.py` & `jal-2023.4.4/jal/widgets/delegates.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/dividend_widget.py` & `jal-2023.4.4/jal/widgets/dividend_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/helpers.py` & `jal-2023.4.4/jal/widgets/helpers.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/income_spending_widget.py` & `jal-2023.4.4/jal/widgets/income_spending_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/main_window.py` & `jal-2023.4.4/jal/widgets/main_window.py`
...
### Comparing `jal-2023.4.3/jal/widgets/mdi.py` & `jal-2023.4.4/jal/widgets/mdi.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/operations_tabs.py` & `jal-2023.4.4/jal/widgets/operations_tabs.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/operations_widget.py` & `jal-2023.4.4/jal/widgets/operations_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/price_chart.py` & `jal-2023.4.4/jal/widgets/price_chart.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/qr_scanner.py` & `jal-2023.4.4/jal/widgets/qr_scanner.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/reference_data.py` & `jal-2023.4.4/jal/widgets/reference_data.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/reference_dialogs.py` & `jal-2023.4.4/jal/widgets/reference_dialogs.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/reference_selector.py` & `jal-2023.4.4/jal/widgets/reference_selector.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/register_designer_plugins.py` & `jal-2023.4.4/jal/widgets/register_designer_plugins.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/selection_dialog.py` & `jal-2023.4.4/jal/widgets/selection_dialog.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/tax_widget.py` & `jal-2023.4.4/jal/widgets/tax_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/trade_widget.py` & `jal-2023.4.4/jal/widgets/trade_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal/widgets/transfer_widget.py` & `jal-2023.4.4/jal/widgets/transfer_widget.py`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/jal.egg-info/PKG-INFO` & `jal-2023.4.4/jal.egg-info/PKG-INFO`
...
### Comparing `jal-2023.4.3/jal.egg-info/SOURCES.txt` & `jal-2023.4.4/jal.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `jal-2023.4.3/setup.py` & `jal-2023.4.4/setup.py`
