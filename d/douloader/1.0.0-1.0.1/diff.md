# Comparing `tmp/douloader-1.0.0.tar.gz` & `tmp/douloader-1.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "douloader-1.0.0.tar", last modified: Fri Mar 24 08:32:31 2023, max compression
+gzip compressed data, was "douloader-1.0.1.tar", last modified: Wed Apr 12 10:30:48 2023, max compression
```

## Comparing `douloader-1.0.0.tar` & `douloader-1.0.1.tar`

### file list

```diff
@@ -1,13 +1,14 @@
-drwxrwxrwx   0        0        0        0 2023-03-24 08:32:31.678328 douloader-1.0.0/
--rw-rw-rw-   0        0        0      466 2023-03-24 08:32:31.678328 douloader-1.0.0/PKG-INFO
--rw-rw-rw-   0        0        0      133 2023-03-24 08:25:55.000000 douloader-1.0.0/README.md
-drwxrwxrwx   0        0        0        0 2023-03-24 08:32:31.668327 douloader-1.0.0/douloader/
--rw-rw-rw-   0        0        0        0 2023-03-24 07:09:17.000000 douloader-1.0.0/douloader/__init__.py
--rw-rw-rw-   0        0        0     7862 2023-03-24 07:57:55.000000 douloader-1.0.0/douloader/dataloaders.py
-drwxrwxrwx   0        0        0        0 2023-03-24 08:32:31.677328 douloader-1.0.0/douloader.egg-info/
--rw-rw-rw-   0        0        0      466 2023-03-24 08:32:31.000000 douloader-1.0.0/douloader.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      197 2023-03-24 08:32:31.000000 douloader-1.0.0/douloader.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-03-24 08:32:31.000000 douloader-1.0.0/douloader.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       10 2023-03-24 08:32:31.000000 douloader-1.0.0/douloader.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-03-24 08:32:31.678328 douloader-1.0.0/setup.cfg
--rw-rw-rw-   0        0        0      554 2023-03-24 08:29:03.000000 douloader-1.0.0/setup.py
+drwxrwxrwx   0        0        0        0 2023-04-12 10:30:48.905156 douloader-1.0.1/
+-rw-rw-rw-   0        0        0       42 2023-04-12 10:16:26.000000 douloader-1.0.1/.gitignore
+-rw-rw-rw-   0        0        0      526 2023-04-12 10:30:48.905156 douloader-1.0.1/PKG-INFO
+-rw-rw-rw-   0        0        0      207 2023-04-12 10:21:09.000000 douloader-1.0.1/README.md
+drwxrwxrwx   0        0        0        0 2023-04-12 10:30:48.896788 douloader-1.0.1/douloader/
+-rw-rw-rw-   0        0        0        0 2023-03-24 07:09:17.000000 douloader-1.0.1/douloader/__init__.py
+-rw-rw-rw-   0        0        0     8808 2023-04-12 10:11:55.000000 douloader-1.0.1/douloader/dataloaders.py
+drwxrwxrwx   0        0        0        0 2023-04-12 10:30:48.905156 douloader-1.0.1/douloader.egg-info/
+-rw-rw-rw-   0        0        0      526 2023-04-12 10:30:48.000000 douloader-1.0.1/douloader.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      208 2023-04-12 10:30:48.000000 douloader-1.0.1/douloader.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-04-12 10:30:48.000000 douloader-1.0.1/douloader.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       10 2023-04-12 10:30:48.000000 douloader-1.0.1/douloader.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2023-04-12 10:30:48.906661 douloader-1.0.1/setup.cfg
+-rw-rw-rw-   0        0        0      614 2023-04-12 10:23:38.000000 douloader-1.0.1/setup.py
```

### Comparing `douloader-1.0.0/douloader/dataloaders.py` & `douloader-1.0.1/douloader/dataloaders.py`
