# Comparing `tmp/gr4vy-0.10.0.tar.gz` & `tmp/gr4vy-0.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gr4vy-0.10.0.tar", max compression
+gzip compressed data, was "gr4vy-0.2.0.tar", max compression
```

## Comparing `gr4vy-0.10.0.tar` & `gr4vy-0.2.0.tar`

### file list

```diff
@@ -1,6 +1,254 @@
--rw-r--r--   0        0        0     1091 2023-04-12 15:27:03.763478 gr4vy-0.10.0/LICENSE
--rw-r--r--   0        0        0     4138 2023-04-12 15:27:03.763645 gr4vy-0.10.0/README.md
--rw-r--r--   0        0        0       61 2023-04-12 15:27:03.763760 gr4vy-0.10.0/gr4vy/__init__.py
--rw-r--r--   0        0        0    14357 2023-04-12 15:27:03.763860 gr4vy-0.10.0/gr4vy/gr4vy_client.py
--rw-r--r--   0        0        0     1418 2023-04-12 15:27:03.764444 gr4vy-0.10.0/pyproject.toml
--rw-r--r--   0        0        0     5052 1970-01-01 00:00:00.000000 gr4vy-0.10.0/PKG-INFO
...
### Comparing `gr4vy-0.10.0/LICENSE` & `gr4vy-0.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `gr4vy-0.10.0/pyproject.toml` & `gr4vy-0.2.0/pyproject.toml`
...
### Comparing `gr4vy-0.10.0/PKG-INFO` & `gr4vy-0.2.0/PKG-INFO`
