# Comparing `tmp/hcpdiff-0.1.4.tar.gz` & `tmp/hcpdiff-0.1.5.tar.gz`
...
## Comparing `hcpdiff-0.1.4.tar` & `hcpdiff-0.1.5.tar`
...
### Comparing `hcpdiff-0.1.4/LICENSE` & `hcpdiff-0.1.5/LICENSE`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/PKG-INFO` & `hcpdiff-0.1.5/README.md`
...
### Comparing `hcpdiff-0.1.4/cfgs/infer/euler_a.yaml` & `hcpdiff-0.1.5/cfgs/infer/euler_a.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/infer/v1.yaml` & `hcpdiff-0.1.5/cfgs/infer/v1.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/te_struct.txt` & `hcpdiff-0.1.5/cfgs/te_struct.txt`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/examples/CustomDiffusion.yaml` & `hcpdiff-0.1.5/cfgs/train/examples/CustomDiffusion.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/examples/DreamArtist++.yaml` & `hcpdiff-0.1.5/cfgs/train/examples/DreamArtist++.yaml`
...
### Comparing `hcpdiff-0.1.4/cfgs/train/examples/DreamBooth.yaml` & `hcpdiff-0.1.5/cfgs/train/examples/DreamBooth.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/examples/TextualInversion.yaml` & `hcpdiff-0.1.5/cfgs/train/examples/TextualInversion.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/examples/fine-tuning.yaml` & `hcpdiff-0.1.5/cfgs/train/examples/fine-tuning.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/examples/locon.yaml` & `hcpdiff-0.1.5/cfgs/train/examples/locon.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/examples/lora_conventional.yaml` & `hcpdiff-0.1.5/cfgs/train/examples/lora_conventional.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/train_base.yaml` & `hcpdiff-0.1.5/cfgs/train/train_base.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/train/tuning_base.yaml` & `hcpdiff-0.1.5/cfgs/train/tuning_base.yaml`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/cfgs/unet_struct.txt` & `hcpdiff-0.1.5/cfgs/unet_struct.txt`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/data/bucket.py` & `hcpdiff-0.1.5/hcpdiff/data/bucket.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/data/pair_dataset.py` & `hcpdiff-0.1.5/hcpdiff/data/pair_dataset.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/data/utils.py` & `hcpdiff-0.1.5/hcpdiff/data/utils.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/cfg_context.py` & `hcpdiff-0.1.5/hcpdiff/models/cfg_context.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/layers.py` & `hcpdiff-0.1.5/hcpdiff/models/layers.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/lora.py` & `hcpdiff-0.1.5/hcpdiff/models/lora.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/lora_layers.py` & `hcpdiff-0.1.5/hcpdiff/models/lora_layers.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/plugin.py` & `hcpdiff-0.1.5/hcpdiff/models/plugin.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/text_emb_ex.py` & `hcpdiff-0.1.5/hcpdiff/models/text_emb_ex.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/textencoder_ex.py` & `hcpdiff-0.1.5/hcpdiff/models/textencoder_ex.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/models/tokenizer_ex.py` & `hcpdiff-0.1.5/hcpdiff/models/tokenizer_ex.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/tools/convert_caption_txt2json.py` & `hcpdiff-0.1.5/hcpdiff/tools/convert_caption_txt2json.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/tools/create_embedding.py` & `hcpdiff-0.1.5/hcpdiff/tools/create_embedding.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/tools/gen_from_ptlist.py` & `hcpdiff-0.1.5/hcpdiff/tools/gen_from_ptlist.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/tools/init_proj.py` & `hcpdiff-0.1.5/hcpdiff/tools/init_proj.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/tools/merge_model_part.py` & `hcpdiff-0.1.5/hcpdiff/tools/merge_model_part.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/train_ac.py` & `hcpdiff-0.1.5/hcpdiff/train_ac.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/train_ac_single.py` & `hcpdiff-0.1.5/hcpdiff/train_ac_single.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/train_colo.py` & `hcpdiff-0.1.5/hcpdiff/train_colo.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/caption_tools.py` & `hcpdiff-0.1.5/hcpdiff/utils/caption_tools.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/cfg_net_tools.py` & `hcpdiff-0.1.5/hcpdiff/utils/cfg_net_tools.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/ckpt_manager/ckpt_pkl.py` & `hcpdiff-0.1.5/hcpdiff/utils/ckpt_manager/ckpt_pkl.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/ckpt_manager/ckpt_safetensor.py` & `hcpdiff-0.1.5/hcpdiff/utils/ckpt_manager/ckpt_safetensor.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/colo_utils.py` & `hcpdiff-0.1.5/hcpdiff/utils/colo_utils.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/ema.py` & `hcpdiff-0.1.5/hcpdiff/utils/ema.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/img_size_tool.py` & `hcpdiff-0.1.5/hcpdiff/utils/img_size_tool.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/utils/utils.py` & `hcpdiff-0.1.5/hcpdiff/utils/utils.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff/visualizer.py` & `hcpdiff-0.1.5/hcpdiff/visualizer.py`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/hcpdiff.egg-info/PKG-INFO` & `hcpdiff-0.1.5/PKG-INFO`
...
### Comparing `hcpdiff-0.1.4/hcpdiff.egg-info/SOURCES.txt` & `hcpdiff-0.1.5/hcpdiff.egg-info/SOURCES.txt`
...
### Comparing `hcpdiff-0.1.4/prompt_tuning_template/object.txt` & `hcpdiff-0.1.5/prompt_tuning_template/object.txt`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/prompt_tuning_template/style.txt` & `hcpdiff-0.1.5/prompt_tuning_template/style.txt`

 * *Files identical despite different names*

### Comparing `hcpdiff-0.1.4/setup.py` & `hcpdiff-0.1.5/setup.py`
