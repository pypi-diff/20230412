# Comparing `tmp/macrometa-target-collection-0.0.48.tar.gz` & `tmp/macrometa-target-collection-0.0.49.tar.gz`
...
## Comparing `macrometa-target-collection-0.0.48.tar` & `macrometa-target-collection-0.0.49.tar`
...
### Comparing `macrometa-target-collection-0.0.48/LICENSE` & `macrometa-target-collection-0.0.49/LICENSE`

 * *Files identical despite different names*

### Comparing `macrometa-target-collection-0.0.48/PKG-INFO` & `macrometa-target-collection-0.0.49/PKG-INFO`
...
### Comparing `macrometa-target-collection-0.0.48/macrometa_target_collection/__init__.py` & `macrometa-target-collection-0.0.49/macrometa_target_collection/__init__.py`

 * *Files identical despite different names*

### Comparing `macrometa-target-collection-0.0.48/macrometa_target_collection/main.py` & `macrometa-target-collection-0.0.49/macrometa_target_collection/main.py`
...
### Comparing `macrometa-target-collection-0.0.48/macrometa_target_collection.egg-info/PKG-INFO` & `macrometa-target-collection-0.0.49/macrometa_target_collection.egg-info/PKG-INFO`
...
### Comparing `macrometa-target-collection-0.0.48/pyproject.toml` & `macrometa-target-collection-0.0.49/pyproject.toml`
