# Comparing `tmp/macrometa-target-collection-0.0.51.tar.gz` & `tmp/macrometa-target-collection-0.0.52.tar.gz`
...
## Comparing `macrometa-target-collection-0.0.51.tar` & `macrometa-target-collection-0.0.52.tar`
...
### Comparing `macrometa-target-collection-0.0.51/LICENSE` & `macrometa-target-collection-0.0.52/LICENSE`

 * *Files identical despite different names*

### Comparing `macrometa-target-collection-0.0.51/PKG-INFO` & `macrometa-target-collection-0.0.52/PKG-INFO`
...
### Comparing `macrometa-target-collection-0.0.51/macrometa_target_collection/__init__.py` & `macrometa-target-collection-0.0.52/macrometa_target_collection/__init__.py`

 * *Files identical despite different names*

### Comparing `macrometa-target-collection-0.0.51/macrometa_target_collection/main.py` & `macrometa-target-collection-0.0.52/macrometa_target_collection/main.py`
...
### Comparing `macrometa-target-collection-0.0.51/macrometa_target_collection.egg-info/PKG-INFO` & `macrometa-target-collection-0.0.52/macrometa_target_collection.egg-info/PKG-INFO`
...
### Comparing `macrometa-target-collection-0.0.51/pyproject.toml` & `macrometa-target-collection-0.0.52/pyproject.toml`
