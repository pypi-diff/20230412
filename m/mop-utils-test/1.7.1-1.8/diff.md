# Comparing `tmp/mop_utils_test-1.7.1.tar.gz` & `tmp/mop_utils_test-1.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mop_utils_test-1.7.1.tar", last modified: Wed Mar 29 06:18:00 2023, max compression
+gzip compressed data, was "mop_utils_test-1.8.tar", last modified: Wed Apr 12 07:40:59 2023, max compression
```

## Comparing `mop_utils_test-1.7.1.tar` & `mop_utils_test-1.8.tar`

### file list

```diff
@@ -1,15 +1,15 @@
-drwxrwxrwx   0        0        0        0 2023-03-29 06:18:00.935077 mop_utils_test-1.7.1/
--rw-rw-rw-   0        0        0      115 2023-03-29 06:18:00.934077 mop_utils_test-1.7.1/PKG-INFO
-drwxrwxrwx   0        0        0        0 2023-03-29 06:18:00.903187 mop_utils_test-1.7.1/mop_utils/
--rw-rw-rw-   0        0        0       89 2023-02-13 07:03:05.000000 mop_utils_test-1.7.1/mop_utils/__init__.py
--rw-rw-rw-   0        0        0     4181 2023-02-16 02:07:15.000000 mop_utils_test-1.7.1/mop_utils/base_model_wrapper.py
--rw-rw-rw-   0        0        0       39 2023-02-16 07:10:11.000000 mop_utils_test-1.7.1/mop_utils/constant.py
--rw-rw-rw-   0        0        0     6264 2023-03-29 06:11:25.000000 mop_utils_test-1.7.1/mop_utils/inference_wrapper.py
-drwxrwxrwx   0        0        0        0 2023-03-29 06:18:00.933075 mop_utils_test-1.7.1/mop_utils_test.egg-info/
--rw-rw-rw-   0        0        0      115 2023-03-29 06:18:00.000000 mop_utils_test-1.7.1/mop_utils_test.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      304 2023-03-29 06:18:00.000000 mop_utils_test-1.7.1/mop_utils_test.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-03-29 06:18:00.000000 mop_utils_test-1.7.1/mop_utils_test.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       40 2023-03-29 06:18:00.000000 mop_utils_test-1.7.1/mop_utils_test.egg-info/requires.txt
--rw-rw-rw-   0        0        0       10 2023-03-29 06:18:00.000000 mop_utils_test-1.7.1/mop_utils_test.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-03-29 06:18:00.935077 mop_utils_test-1.7.1/setup.cfg
--rw-rw-rw-   0        0        0      352 2023-03-29 06:17:57.000000 mop_utils_test-1.7.1/setup.py
...
### Comparing `mop_utils_test-1.7.1/mop_utils/base_model_wrapper.py` & `mop_utils_test-1.8/mop_utils/base_model_wrapper.py`
...
### Comparing `mop_utils_test-1.7.1/mop_utils/inference_wrapper.py` & `mop_utils_test-1.8/mop_utils/inference_wrapper.py`
