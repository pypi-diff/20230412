# Comparing `tmp/cxlint-1.0.1.tar.gz` & `tmp/cxlint-1.0.2.tar.gz`
...
### Comparing `cxlint-1.0.1/PKG-INFO` & `cxlint-1.0.2/PKG-INFO`
...
### Comparing `cxlint-1.0.1/LICENSE.txt` & `cxlint-1.0.2/LICENSE.txt`
