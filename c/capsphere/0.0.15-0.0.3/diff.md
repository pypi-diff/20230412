# Comparing `tmp/capsphere-0.0.15.tar.gz` & `tmp/capsphere-0.0.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "capsphere-0.0.15.tar", last modified: Wed Apr 12 08:41:39 2023, max compression
+gzip compressed data, was "capsphere-0.0.3.tar", last modified: Mon Mar 20 11:42:15 2023, max compression
```

## Comparing `capsphere-0.0.15.tar` & `capsphere-0.0.3.tar`

### file list

```diff
@@ -1,63 +1,40 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/
--rw-r--r--   0 runner    (1001) docker     (123)     1389 2023-04-12 08:41:39.368268 capsphere-0.0.15/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1047 2023-04-12 08:40:59.000000 capsphere-0.0.15/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.360268 capsphere-0.0.15/capsphere/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.364268 capsphere-0.0.15/capsphere/common/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      511 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/date.py
--rw-r--r--   0 runner    (1001) docker     (123)      281 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/logger.py
--rw-r--r--   0 runner    (1001) docker     (123)      131 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/s3.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.364268 capsphere-0.0.15/capsphere/common/test/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/test/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      565 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/test/test_date.py
--rw-r--r--   0 runner    (1001) docker     (123)      333 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/test/test_s3.py
--rw-r--r--   0 runner    (1001) docker     (123)     2066 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/test/test_utils.py
--rw-r--r--   0 runner    (1001) docker     (123)     1994 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/common/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.364268 capsphere-0.0.15/capsphere/domain/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.364268 capsphere-0.0.15/capsphere/domain/input/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/input/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      138 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/input/bank.py
--rw-r--r--   0 runner    (1001) docker     (123)     3770 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/input/model.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/domain/output/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/output/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2582 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/output/excel.py
--rw-r--r--   0 runner    (1001) docker     (123)     1805 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/output/model.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/domain/output/test/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/output/test/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     3808 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/output/test/test_excel.py
--rw-r--r--   0 runner    (1001) docker     (123)     1147 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/domain/output/test/test_model.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/recognition/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/recognition/plumber/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/plumber/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     7288 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/plumber/converter.py
--rw-r--r--   0 runner    (1001) docker     (123)      816 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/plumber/reader.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/recognition/plumber/test/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/plumber/test/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1565 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/plumber/test/test_converter.py
--rw-r--r--   0 runner    (1001) docker     (123)     1906 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/plumber/test/test_reader.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/recognition/pytesseract/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/pytesseract/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/recognition/textract/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/textract/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2245 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/textract/extract.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/recognition/textract/test/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/textract/test/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1774 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/recognition/textract/test/test_extract.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/resources/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/resources/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2111 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/resources/schema.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.368268 capsphere-0.0.15/capsphere/resources/test/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/resources/test/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)   169258 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/resources/test/ambank.pdf
--rw-r--r--   0 runner    (1001) docker     (123)      956 2023-04-12 08:40:59.000000 capsphere-0.0.15/capsphere/resources/test/data.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-12 08:41:39.360268 capsphere-0.0.15/capsphere.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1389 2023-04-12 08:41:39.000000 capsphere-0.0.15/capsphere.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1538 2023-04-12 08:41:39.000000 capsphere-0.0.15/capsphere.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-12 08:41:39.000000 capsphere-0.0.15/capsphere.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       64 2023-04-12 08:41:39.000000 capsphere-0.0.15/capsphere.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-04-12 08:41:39.000000 capsphere-0.0.15/capsphere.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-04-12 08:41:39.368268 capsphere-0.0.15/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1029 2023-04-12 08:40:59.000000 capsphere-0.0.15/setup.py
...
### Comparing `capsphere-0.0.15/capsphere/common/test/test_date.py` & `capsphere-0.0.3/capsphere/common/test/test_date.py`
...
### Comparing `capsphere-0.0.15/capsphere/domain/input/model.py` & `capsphere-0.0.3/capsphere/domain/input/model.py`
...
### Comparing `capsphere-0.0.15/capsphere/domain/output/model.py` & `capsphere-0.0.3/capsphere/domain/output/model.py`
...
### Comparing `capsphere-0.0.15/capsphere/domain/output/test/test_excel.py` & `capsphere-0.0.3/capsphere/domain/output/test/test_excel.py`
...
### Comparing `capsphere-0.0.15/capsphere/resources/test/data.py` & `capsphere-0.0.3/capsphere/domain/output/test/resources/data.py`
...
### Comparing `capsphere-0.0.15/capsphere.egg-info/SOURCES.txt` & `capsphere-0.0.3/capsphere.egg-info/SOURCES.txt`

 * *Files 24% similar despite different names*

```diff
@@ -4,15 +4,14 @@
 capsphere.egg-info/PKG-INFO
 capsphere.egg-info/SOURCES.txt
 capsphere.egg-info/dependency_links.txt
 capsphere.egg-info/requires.txt
 capsphere.egg-info/top_level.txt
 capsphere/common/__init__.py
 capsphere/common/date.py
-capsphere/common/logger.py
 capsphere/common/s3.py
 capsphere/common/utils.py
 capsphere/common/test/__init__.py
 capsphere/common/test/test_date.py
 capsphere/common/test/test_s3.py
 capsphere/common/test/test_utils.py
 capsphere/domain/__init__.py
@@ -21,24 +20,9 @@
 capsphere/domain/input/model.py
 capsphere/domain/output/__init__.py
 capsphere/domain/output/excel.py
 capsphere/domain/output/model.py
 capsphere/domain/output/test/__init__.py
 capsphere/domain/output/test/test_excel.py
 capsphere/domain/output/test/test_model.py
-capsphere/recognition/__init__.py
-capsphere/recognition/plumber/__init__.py
-capsphere/recognition/plumber/converter.py
-capsphere/recognition/plumber/reader.py
-capsphere/recognition/plumber/test/__init__.py
-capsphere/recognition/plumber/test/test_converter.py
-capsphere/recognition/plumber/test/test_reader.py
-capsphere/recognition/pytesseract/__init__.py
-capsphere/recognition/textract/__init__.py
-capsphere/recognition/textract/extract.py
-capsphere/recognition/textract/test/__init__.py
-capsphere/recognition/textract/test/test_extract.py
-capsphere/resources/__init__.py
-capsphere/resources/schema.json
-capsphere/resources/test/__init__.py
-capsphere/resources/test/ambank.pdf
-capsphere/resources/test/data.py
+capsphere/domain/output/test/resources/__init__.py
+capsphere/domain/output/test/resources/data.py
```

### Comparing `capsphere-0.0.15/setup.py` & `capsphere-0.0.3/setup.py`
