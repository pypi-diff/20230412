# Comparing `tmp/naruno_tests-0.56.1.tar.gz` & `tmp/naruno_tests-0.56.2.tar.gz`
...
## Comparing `naruno_tests-0.56.1.tar` & `naruno_tests-0.56.2.tar`
...
### Comparing `naruno_tests-0.56.1/setup.py` & `naruno_tests-0.56.2/setup.py`
