# Comparing `tmp/tencentcloud-sdk-python-dataintegration-3.0.870.tar.gz` & `tmp/tencentcloud-sdk-python-dataintegration-3.0.871.tar.gz`
...
## Comparing `tencentcloud-sdk-python-dataintegration-3.0.870.tar` & `tencentcloud-sdk-python-dataintegration-3.0.871.tar`
...
### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/PKG-INFO` & `tencentcloud-sdk-python-dataintegration-3.0.871/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/tencentcloud/__init__.py` & `tencentcloud-sdk-python-dataintegration-3.0.871/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/tencentcloud/dataintegration/v20220613/models.py` & `tencentcloud-sdk-python-dataintegration-3.0.871/tencentcloud/dataintegration/v20220613/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/tencentcloud/dataintegration/v20220613/dataintegration_client.py` & `tencentcloud-sdk-python-dataintegration-3.0.871/tencentcloud/dataintegration/v20220613/dataintegration_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/tencentcloud/dataintegration/v20220613/errorcodes.py` & `tencentcloud-sdk-python-dataintegration-3.0.871/tencentcloud/dataintegration/v20220613/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/README.rst` & `tencentcloud-sdk-python-dataintegration-3.0.871/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/setup.py` & `tencentcloud-sdk-python-dataintegration-3.0.871/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/tencentcloud_sdk_python_dataintegration.egg-info/PKG-INFO` & `tencentcloud-sdk-python-dataintegration-3.0.871/tencentcloud_sdk_python_dataintegration.egg-info/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-dataintegration-3.0.870/tencentcloud_sdk_python_dataintegration.egg-info/SOURCES.txt` & `tencentcloud-sdk-python-dataintegration-3.0.871/tencentcloud_sdk_python_dataintegration.egg-info/SOURCES.txt`
