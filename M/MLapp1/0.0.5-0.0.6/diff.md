# Comparing `tmp/MLapp1-0.0.5.tar.gz` & `tmp/MLapp1-0.0.6.tar.gz`
...
## Comparing `MLapp1-0.0.5.tar` & `MLapp1-0.0.6.tar`
...
### Comparing `MLapp1-0.0.5/LICENSE.toml` & `MLapp1-0.0.6/LICENSE.toml`

 * *Files identical despite different names*

### Comparing `MLapp1-0.0.5/setup.cfg` & `MLapp1-0.0.6/setup.cfg`
