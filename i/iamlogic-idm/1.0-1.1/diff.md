# Comparing `tmp/iamlogic_idm-1.0.tar.gz` & `tmp/iamlogic_idm-1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "iamlogic_idm-1.0.tar", last modified: Fri Apr  7 20:20:30 2023, max compression
+gzip compressed data, was "iamlogic_idm-1.1.tar", last modified: Wed Apr 12 19:12:19 2023, max compression
```

## Comparing `iamlogic_idm-1.0.tar` & `iamlogic_idm-1.1.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxrwxrwx   0        0        0        0 2023-04-07 20:20:30.062918 iamlogic_idm-1.0/
--rw-rw-rw-   0        0        0      432 2023-04-07 20:20:30.061918 iamlogic_idm-1.0/PKG-INFO
-drwxrwxrwx   0        0        0        0 2023-04-07 20:20:30.052629 iamlogic_idm-1.0/iamlogic_idm.egg-info/
--rw-rw-rw-   0        0        0      432 2023-04-07 20:20:29.000000 iamlogic_idm-1.0/iamlogic_idm.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      244 2023-04-07 20:20:29.000000 iamlogic_idm-1.0/iamlogic_idm.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-04-07 20:20:29.000000 iamlogic_idm-1.0/iamlogic_idm.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       61 2023-04-07 20:20:29.000000 iamlogic_idm-1.0/iamlogic_idm.egg-info/requires.txt
--rw-rw-rw-   0        0        0       14 2023-04-07 20:20:29.000000 iamlogic_idm-1.0/iamlogic_idm.egg-info/top_level.txt
-drwxrwxrwx   0        0        0        0 2023-04-07 20:20:30.057915 iamlogic_idm-1.0/idm_operation/
--rw-rw-rw-   0        0        0     8837 2023-04-05 19:42:58.000000 iamlogic_idm-1.0/idm_operation/IDM_Operation.py
--rw-rw-rw-   0        0        0        0 2023-03-31 04:53:08.000000 iamlogic_idm-1.0/idm_operation/__init__.py
--rw-rw-rw-   0        0        0       42 2023-04-07 20:20:30.063920 iamlogic_idm-1.0/setup.cfg
--rw-rw-rw-   0        0        0      642 2023-04-07 20:20:03.000000 iamlogic_idm-1.0/setup.py
...
### Comparing `iamlogic_idm-1.0/idm_operation/IDM_Operation.py` & `iamlogic_idm-1.1/idm_operation/IDM_Operation.py`
...
### Comparing `iamlogic_idm-1.0/setup.py` & `iamlogic_idm-1.1/setup.py`
